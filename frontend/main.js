    ...
    if (!window.rendered) {
      ...
      docReady(function () {
        ...
        const html5QrCode = new Html5Qrcode("qr-reader");        
           // Configuration to include multiple barcode types
           const config = { 
            fps: 10, 
            qrbox: { width: 2*(height-10), height: height-10 },
            formatsToSupport: [
                Html5QrcodeSupportedFormats.QR_CODE,
                Html5QrcodeSupportedFormats.CODE_128, // Code 128 barcodes
                Html5QrcodeSupportedFormats.EAN_13,  // EAN-13 barcodes
                Html5QrcodeSupportedFormats.UPC_A    // UPC-A barcodes
            ]
        };

        // Start scanning with support for multiple formats
